...
function appendFoodToTable(food, index){
  var row = "<tr id='" + index +"'><td contenteditable='true' class='enclosed-cells food-cell'>" + food.name + "</td><td contenteditable='true' class='enclosed-cells calorie-cell'>" + food.calories + "</td></tr>"
...
function appendExerciseToTable(exercise, index){
  var row = "<tr id='" + index +"'><td contenteditable='true' class='enclosed-cells exercise-cell'>" + exercise.name + "</td><td contenteditable='true' class='enclosed-cells calorie-cell'>" + exercise.calories + "</td></tr>"
