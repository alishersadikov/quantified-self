...
function sortByCalories(tableName){
  var tablesToLocalStorage = {"food-table":"foods", "exercise-table":"exercises"}
  var key = tablesToLocalStorage[tableName]
  debugger;
}
...
$('#food-table > thead > tr > th:nth-child(3)').on('click', function(){
  sortByCalories(this.parentElement.parentElement.parentElement.id)
});
