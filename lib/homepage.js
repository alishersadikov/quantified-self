...
var foodCount = 1; // 0 is standard order, 1 is ascending, 2 is descending order
var exerciseCount = 1; // 0 is standard order, 1 is ascending, 2 is descending order
...
function countUpdater(key){
  if (key == "foods") {
    foodCount == 3 ? foodCount = 1 : foodCount ++
  } else {
    exerciseCount == 3 ? exerciseCount = 1 : exerciseCount ++
  }
  // debugger;
}
